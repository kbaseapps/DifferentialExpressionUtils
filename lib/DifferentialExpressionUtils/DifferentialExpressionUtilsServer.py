...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'DifferentialExpressionUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from DifferentialExpressionUtils.DifferentialExpressionUtilsImpl import DifferentialExpressionUtils  # noqa @IgnorePep8
impl_DifferentialExpressionUtils = DifferentialExpressionUtils(config)
